...
export default function WarehouseActivityView() {
  ...
  const dispatches = [
    { id: 'disp-1', customer: 'ABC Trading', details: `5 ${t.inventory.cartons} · Shower Gel`, time: '2h ago', avatar: 'AB' },
    { id: 'disp-2', customer: 'Mame Shop', details: `10 ${t.inventory.cartons} · Soap`, time: '5h ago', avatar: 'MS' },
    { id: 'disp-3', customer: 'XYZ Wholesale', details: `15 ${t.inventory.cartons} · Shampoo`, time: '7h ago', avatar: 'XY' },
    { id: 'disp-4', customer: 'Reta Retail', details: `8 ${t.inventory.cartons} · Water Bottle`, time: '1d ago', avatar: 'RR' },
  ];
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500">{t.warehouse.subtitle}</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        <div className="bg-[#EFF6FF] border border-blue-100 rounded-2xl p-3 shadow-2xs">
          ...
          <p className="text-base sm:text-lg font-extrabold text-slate-900 mt-0.5 font-mono">{metrics.inStockCartons}</p>
        ...
        <div className="bg-[#ECFDF5] border border-emerald-100 rounded-2xl p-3 shadow-2xs">
          ...
          <p className="text-base sm:text-lg font-extrabold text-slate-900 mt-0.5 font-mono">{metrics.incomingCartons}</p>
        ...
        <div className="bg-[#FFF7ED] border border-orange-100 rounded-2xl p-3 shadow-2xs">
          ...
          <p className="text-base sm:text-lg font-extrabold text-slate-900 mt-0.5 font-mono">{metrics.outgoingCartons}</p>
      ...
      <div className="bg-white border border-slate-200/70 rounded-2xl p-4 shadow-2xs">
        <div className="flex items-center justify-between pb-3 mb-2 border-b border-slate-100">
          <h2 className="text-xs font-bold text-slate-900 uppercase tracking-wider">{t.warehouse.recentDispatches}</h2>
      ...
      >
        ...
        <span>{t.warehouse.logDispatch}</span>
      </button>
    </div>
  );
}
